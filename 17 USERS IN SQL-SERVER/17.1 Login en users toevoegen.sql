...
CREATE LOGIN [SCHOOL\Student1] FROM WINDOWS
USE GameTracker;
CREATE USER [Student1] FOR LOGIN [SCHOOL\Student1]
EXEC sp_addrolemember 'db_datareader', 'Student1'

-- Windows users toevoegen \ Lezen, bewerken
CREATE LOGIN [SCHOOL\Student2] FROM WINDOWS
USE GameTracker;
CREATE USER [Student2] FOR LOGIN [SCHOOL\Student2]
